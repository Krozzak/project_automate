...
**Visuel** : 1 iconographie (Ego Depletion)
...
1 iconographie (Ego Depletion) — image seule, pas de carousel.

### Prompt DALL-E utilisé

```
Crée une image infographique épurée et moderne avec un fond clair (blanc ou gris très clair type #f5f5f5).
...
SECTION HAUTE :
- Titre en texte sombre : « La volonté est un budget. »
- Sous-titre plus petit en gris : « Ego Depletion — Roy Baumeister, 1998 »

SECTION CENTRALE :
- Une barre de batterie horizontale qui se vide progressivement de gauche à droite
- À gauche : batterie pleine (vert #2ecc71), label "Matin"
- Au milieu : batterie à moitié (orange #e67e22), label "Après-midi"
- À droite : batterie quasi vide (rouge #e74c3c), label "Soir"
- Au-dessus de la barre, de petites icônes minimalistes qui s'accumulent de gauche à droite, représentant les micro-décisions qui drainent la batterie au fil de la journée :
  un dossier (où je range ça ?), une liste (par quoi je commence ?), une horloge (maintenant ou plus tard ?), un point d'exclamation (urgent ou pas ?), un cerveau fatigué
- Les icônes s'empilent et deviennent plus nombreuses vers la droite, montrant l'accumulation

SECTION BASSE :
- Deux lignes contrastées :
  - À gauche avec une croix rouge : « Forcer plus »
  - À droite avec un check vert : « Décider moins »

STYLE :
- Esthétique light mode (fond clair, texte sombre)
- Couleurs d'accent : vert (#2ecc71), orange (#e67e22), rouge (#e74c3c), cyan (#00b4d8)
...
- **Attention** : l'ego depletion est controversé (crise de réplication, 23 labos n'ont pas reproduit l'effet). Notre post reste valide car basé sur l'expérience personnelle + modèle mental utile, pas sur une affirmation scientifique absolue
